...
import com.example.biometricvision.service.Sasistencia;
    ...
    public ResponseEntity<?> asistencia(@RequestParam(name="ide") Long ide,@RequestParam(name="idh") Long idh)
    {
        ...
        try
        {
            if(ide!=null && idh!=null)
            {
                ...
                asi.setIdestudiante(est);
                asi.setIdhorario(hor);
                Asistencia asistencia=sasistencia.guardar_actualizar(asi);
