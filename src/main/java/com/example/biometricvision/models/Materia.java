...
public class Materia implements Serializable 
{
    ...
    @Column(name = "nombremateria", nullable = false, unique = true, length = 100)
    String nombremateria;
    
    @ManyToOne
    @JoinColumn(name = "idsemestre", nullable = false, unique = false)
    Semestre idsemestre;
    
    @ManyToOne
    @JoinColumn(name = "idcarrera", nullable = false, unique = false)
    Carrera idcarrera;
    
    @Column(name = "cupos", nullable = false, unique = false)
    int cupos;
